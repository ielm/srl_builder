...
if __name__ == '__main__':
    with open('/remote/ayuser/leoni/gator_data/Persuasion/svo_dialogs.json', 'r', encoding='utf8') as file:
        data = [d for d in json.loads(file.read()) if not "BAD" in d['dialog_id']]

    srl_predictor = Predictor.from_path("https://storage.googleapis.com/allennlp-public-models/structured-prediction-srl-bert.2020.12.15.tar.gz")
    dep_predictor = Predictor.from_path("https://storage.googleapis.com/allennlp-public-models/biaffine-dependency-parser-ptb-2020.04.06.tar.gz")
    ...
    with open('/remote/ayuser/leoni/gator_data/Persuasion/srl_dialogs.json', 'w', encoding='utf8') as wfile:
